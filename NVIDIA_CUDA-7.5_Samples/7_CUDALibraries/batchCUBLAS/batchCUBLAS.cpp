...
// #define BENCH_MATRIX_M              (256)
// #define BENCH_MATRIX_K              (256)
// #define BENCH_MATRIX_N              (256)
...
{
    BENCH_MATRIX_M = atoi(argv[1]);
    BENCH_MATRIX_N = atoi(argv[1]);
    BENCH_MATRIX_K = atoi(argv[1]);
